...
class Setuptrenddsm():
    ...
    def trenddsmsetup(self, dsmsecretspath, region, domain, endpointurl):
        ...
        select.select_by_visible_text('TLS')
...
def main(args):
    ...
    driver.trenddsmsetup(args.dsmsecretspath,
                         args.region, args.domain, args.endpointurl)
